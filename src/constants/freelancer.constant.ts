...
export const FREELANCER_UPDATE_PROJECT_BY_ID = "/:freelancer_id/project/:project_id";
export const FREELANCER_PROJECT_DELETE_BY_ID = "/:freelancer_id/project/:project_id";

// experience endpoint
export const FREELANCER_CREATE_EXPERIENCE_BY_ID = "/:freelancer_id/experience";
export const FREELANCER_UPDATE_EXPERIENCE_BY_ID = "/:freelancer_id/experience/:experience_id";
export const FREELANCER_EXPERINCE_DELETE_BY_ID = "/:freelancer_id/experience/:experience_id";

// education endpoint
export const FREELANCER_CREATE_EDUCATION_BY_ID = "/:freelancer_id/education";
export const FREELANCER_UPDATE_EDUCATION_BY_ID = "/:freelancer_id/education/:education_id";
export const FREELANCER_DELETE_EDUCATION_BY_ID = "/:freelancer_id/education/:education_id";
