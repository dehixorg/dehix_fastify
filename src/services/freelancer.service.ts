...
export class FreelancerService extends BaseService {
  ...
  async createConsultant(freelancer_id:string,body:any){
    this.logger.info(
      "FreelancerService: createConsultant",
      freelancer_id,
    );
  ...
  async updateConsultant(freelancer_id:string,consultant_id:string,update:any){
    this.logger.info(
      "FreelancerService: updateConsultant",
      freelancer_id,
    );
    const freelancerExist= await this.FreelancerDAO.findFreelancerById(freelancer_id)
    if (!freelancerExist) {
    ...
    const consultantExist =
      await this.FreelancerDAO.getConsultantById(freelancer_id,consultant_id);
    if (!consultantExist) {
      throw new NotFoundError(
    ...
    const data= await this.FreelancerDAO.updateConsultant(freelancer_id,consultant_id,update)
    return data;
  }
  async getConsultantById(freelancer_id:string,consultant_id:string){
    this.logger.info(
      "FreelancerService:  getConsultantById",
      freelancer_id,
    );
    const freelancerExist= await this.FreelancerDAO.findFreelancerById(freelancer_id)
    if (!freelancerExist) {
    ...
    const data =
    await this.FreelancerDAO.getConsultant(freelancer_id,consultant_id);
  if (!data) {
    throw new NotFoundError(
      RESPONSE_MESSAGE.CONSULTANT_NOT_FOUND,
      ERROR_CODES.NOT_FOUND,
  ...
  async deleteConsultant(freelancer_id:string,consultant_id:string){
    ...
    const data= await this.FreelancerDAO.deleteConsultant(freelancer_id,consultant_id)
  }
}
/**
