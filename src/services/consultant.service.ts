...
const consultantExist= await this.ConsultantDao.getConsultantById(consultant_id);
if (!consultantExist) {
...
const data= await this.ConsultantDao.updateConsultant(consultant_id,update)
return data
}
