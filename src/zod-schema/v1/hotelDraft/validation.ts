...
export const additionalDetailsSchema = z.object({
  ...
  awards: z
    ...
    .optional(),
  trade_licenses: z.array(z.string()).nonempty('Trade license link is required'),
});
//.strict();
...
const pricingTypes = z.enum(['VENUE_RENTAL', 'MIN_SPEND_PER_PERSON', 'MIN_SPEND_PRICINGS', 'ACCOMMODATION']);
...
export const photosAndVideosSchema = z.object({
  ...
  video_upload_type: z.string(videoUplodeTypeEnum).nonempty('Video Uplode type'),
});
//.strict();
