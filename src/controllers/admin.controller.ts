...
import { ADMIN_ALL_ENDPOINT, ADMIN_ENDPOINT, ADMIN_ID_ENDPOINT, DELETE_ADMIN_BY_ID_ENDPOINT } from "../constants/admin.constant";
...
import { deleteAdminPathParams } from "../types/v1/admin/deleteAdmin";
import { deleteAdminSchema } from "../schema/v1/admin/admin.delete";
import { getAllAdminSchema } from "../schema/v1/admin/admin.get";
...
export default class AdminsController extends AuthController {
  ...
  async deleteAdminById(
    request: FastifyRequest<{ Params: deleteAdminPathParams }>,
    reply: FastifyReply,
  ) {
    try {
      this.logger.info(
      ...
      await this.adminsService.deleteSkillById(request.params.admin_id);
